@echo off
chcp 65001 >nul
title Guitar-to-Doom: Ultimate DOOM
cd /d "%~dp0"

echo ================================================
echo   Guitar-to-Doom Controller Pro
echo   The Ultimate DOOM
echo ================================================
echo.
...
start "" gzdoom.exe -config "%~dp0gzdoom.ini" -savedir "%~dp0save" -iwad "%~dp0iwads\doom.wad" -file "%~dp0lights.pk3" "%~dp0brightmaps.pk3" "%~dp0game_support.pk3" "%~dp0game_widescreen_gfx.pk3" "%~dp0mods\audio\IDKFAv2.wad" "%~dp0mods\graphics\NeuralUpscale2x_v1.0.pk3"
