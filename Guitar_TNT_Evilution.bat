@echo off
chcp 65001 >nul
title Guitar-to-Doom: Final Doom - TNT
cd /d "%~dp0"

echo ================================================
echo   Guitar-to-Doom Controller Pro
echo   TNT: Evilution (Final Doom)
echo ================================================
echo.
...
start "" gzdoom.exe -config "%~dp0gzdoom.ini" -savedir "%~dp0save" -iwad "%~dp0iwads\tnt.wad" -file "%~dp0lights.pk3" "%~dp0brightmaps.pk3" "%~dp0game_support.pk3" "%~dp0game_widescreen_gfx.pk3" "%~dp0mods\audio\IDKFAv2.wad" "%~dp0mods\graphics\NeuralUpscale2x_v1.0.pk3"
timeout /t 2 /nobreak >nul

echo [OK] GZDoom + TNT запущены
